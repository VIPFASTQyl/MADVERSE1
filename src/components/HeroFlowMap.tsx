...
const HeroFlowMap: React.FC = () => {
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    // Load OGL library
    const script = document.createElement('script');
    script.src = 'https://cdn.jsdelivr.net/npm/ogl@0.0.45/dist/ogl.umd.js';
    script.async = true;
    script.onload = () => {
      initFlowMap();
    };
    ...
    const initFlowMap = () => {
      ...
      if (isTouchCapable) {
        ...
        window.addEventListener('touchmove', updateMouse as any, { passive: false });
      } else {
  ...
  return (
    <div ref={containerRef} className="hero-flowmap">
      <div className="mask">
        <svg
          version="1.1"
          id="Layer_1"
