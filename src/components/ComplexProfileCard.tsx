...
const ComplexProfileCard = ({
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="bg-gradient-to-b from-gray-800 to-black rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 h-auto flex flex-col">
        {/* Image Section */}
        ...
        {/* Content Section */}
        <div className="px-6 py-8 flex-grow flex flex-col justify-start gap-6">
          {/* Info */}
          <div className="space-y-3">
            <h3 className="text-2xl font-bold text-white leading-tight">{name}</h3>
            <p className="text-cyan-400 text-sm font-semibold tracking-wide uppercase">{position}</p>
            {description && (
